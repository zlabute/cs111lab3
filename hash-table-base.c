...
static struct hash_table_entry *get_hash_table_entry(struct hash_table_base *hash_table,
                                                     const char *key)
{
	assert(key != NULL);
...
static struct list_entry *get_list_entry(struct hash_table_base *hash_table,
                                         const char *key,
                                         struct list_head *list_head)
{
	assert(key != NULL);
